...
- **Required Inputs**: service_name, git_repo
- **Optional Inputs**: branch

### get_service_status
- **Description**: Gets Render service status
- **Required Inputs**: service_id
...
```javascript
const response = await fetch('http://localhost:3006/tool', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    unique_id: 'HEIR-2024-12-RENDER-001',
...
```env
RENDER_MCP_API_KEY=your_api_key_here
