...
var ToolkitAuthFieldSchema = import_zod7.z.object({
  ...
  required: import_zod7.z.boolean(),
  name: import_zod7.z.string(),
...
var MCPServerInstanceSchema = import_zod10.default.object({
  id: import_zod10.default.string(),
  name: import_zod10.default.string(),
  type: import_zod10.default.literal("streamable_http"),
  url: import_zod10.default.string(),
  userId: import_zod10.default.string(),
  allowedTools: import_zod10.default.array(import_zod10.default.string()),
  authConfigs: import_zod10.default.array(import_zod10.default.string())
});
var MCPConfigToolkitsSchema = import_zod10.default.object({
  toolkit: import_zod10.default.string().describe("Id of the toolkit").optional(),
  authConfigId: import_zod10.default.string().describe("Id of the auth config").optional()
});
var MCPConfigCreationParamsSchema = import_zod10.default.object({
  toolkits: import_zod10.default.array(import_zod10.default.union([MCPConfigToolkitsSchema, import_zod10.default.string()])),
  allowedTools: import_zod10.default.array(import_zod10.default.string()).optional(),
  manuallyManageConnections: import_zod10.default.boolean().default(false).optional().describe(
...
var MCPConfigResponseSchema = import_zod10.default.object({
  /**
...
var MCPListParamsSchema = import_zod10.default.object({
  page: import_zod10.default.number().optional().default(1),
  limit: import_zod10.default.number().optional().default(10),
  toolkits: import_zod10.default.array(import_zod10.default.string()).optional().default([]),
  authConfigs: import_zod10.default.array(import_zod10.default.string()).optional().default([]),
  name: import_zod10.default.string().optional()
});
var MCPItemSchema = MCPConfigResponseSchema.extend({
  ...import_zod10.default.object({
    toolkitIcons: import_zod10.default.record(import_zod10.default.string(), import_zod10.default.string()),
    serverInstanceCount: import_zod10.default.number(),
    toolkits: import_zod10.default.array(import_zod10.default.string())
  }).shape
});
var MCPListResponseSchema = import_zod10.default.object({
  items: import_zod10.default.array(MCPItemSchema),
  currentPage: import_zod10.default.number(),
  totalPages: import_zod10.default.number()
});
var MCPUpdateParamsSchema = import_zod10.default.object({
  name: import_zod10.default.string().optional(),
  toolkits: import_zod10.default.array(import_zod10.default.union([MCPConfigToolkitsSchema, import_zod10.default.string()])).optional(),
  allowedTools: import_zod10.default.array(import_zod10.default.string()).optional(),
  manuallyManageConnections: import_zod10.default.boolean().optional().describe(
    `Whether to manually manage accounts. If true, you need to manage accounts manually connect user accounts. 
If set to false, composio will inject account maangement tools into your mcp server for agents to request and authenticate accounts.
defaults to false`
  )
});
var MCPServerConnectionStatus = import_zod10.default.object({
  connected: import_zod10.default.boolean(),
  toolkit: import_zod10.default.string(),
  connectedAccountId: import_zod10.default.string()
});
var MCPServerConnectedAccountsSchema = import_zod10.default.record(
  import_zod10.default.string(),
  import_zod10.default.array(
    import_zod10.default.object({
      toolkit: import_zod10.default.string(),
      authConfigId: import_zod10.default.string(),
      connectedAccountId: import_zod10.default.string()
    })
  )
);
...
var MCPToolkitConfigSchema = import_zod11.z.object({
  toolkit: import_zod11.z.string().min(1, "Toolkit name cannot be empty"),
  authConfigId: import_zod11.z.string().min(1, "Auth config ID cannot be empty"),
  allowedTools: import_zod11.z.array(import_zod11.z.string().min(1, "Tool name cannot be empty")).min(1, "At least one tool must be specified")
});
var MCPToolkitConfigsArraySchema = import_zod11.z.array(MCPToolkitConfigSchema).min(1, "At least one toolkit configuration is required").refine((configs) => {
...
var MCPAuthOptionsSchema = import_zod11.z.object({
  isChatAuth: import_zod11.z.boolean().optional()
});
var MCPGetServerParamsSchema = import_zod11.z.object({
  userId: import_zod11.z.string().min(1, "User ID cannot be empty").optional(),
  connectedAccountIds: import_zod11.z.record(import_zod11.z.string(), import_zod11.z.string().min(1, "Account ID cannot be empty")).optional()
}).refine(
  (data) => {
...
var MCPGenerateURLParamsSchema = import_zod11.z.object({
  userIds: import_zod11.z.array(import_zod11.z.string()).optional(),
  connectedAccountIds: import_zod11.z.array(import_zod11.z.string()).optional(),
  isChatAuth: import_zod11.z.boolean().optional()
});
var ComposioGenerateURLParamsSchema = import_zod11.z.object({
  user_ids: import_zod11.z.array(import_zod11.z.string()).optional(),
  connected_account_ids: import_zod11.z.array(import_zod11.z.string()).optional(),
  mcp_server_id: import_zod11.z.string(),
  managed_auth_by_composio: import_zod11.z.boolean().optional()
});
var GenerateURLParamsSchema = import_zod11.z.object({
  userIds: import_zod11.z.array(import_zod11.z.string()).optional(),
  connectedAccountIds: import_zod11.z.array(import_zod11.z.string()).optional(),
  mcpServerId: import_zod11.z.string(),
  composioManagedAuth: import_zod11.z.boolean().optional()
});
var GenerateURLResponseSchema = import_zod11.z.object({
  connectedAccountUrls: import_zod11.z.array(import_zod11.z.string()).optional(),
  userIdsUrl: import_zod11.z.array(import_zod11.z.string()).optional(),
  mcpUrl: import_zod11.z.string().min(1, "MCP URL cannot be empty")
});
var ComposioGenerateURLResponseSchema = import_zod11.z.object({
  connected_account_urls: import_zod11.z.array(import_zod11.z.string()).optional(),
  user_ids_url: import_zod11.z.array(import_zod11.z.string()).optional(),
  mcp_url: import_zod11.z.string().min(1, "MCP URL cannot be empty")
});
var MCPSingleAppServerSchema = import_zod11.z.object({
  name: import_zod11.z.string().describe("Name of the MCP server"),
  tools: import_zod11.z.array(import_zod11.z.string()).describe("List of allowed tools"),
  authConfigId: import_zod11.z.string().optional().describe("Auth config ID for the server")
});
var MCPMultiAppServerSchema = import_zod11.z.object({
  name: import_zod11.z.string().describe("Name of the MCP server"),
  tools: import_zod11.z.array(import_zod11.z.string()).describe("List of allowed tools across toolkits"),
  toolkits: import_zod11.z.array(import_zod11.z.string()).describe("List of allowed toolkits")
});
var MCPServerSchema = import_zod11.z.object({
  id: import_zod11.z.string().describe("Unique identifier for the MCP server"),
  type: import_zod11.z.enum(["single", "multi"]).describe("Type of MCP server"),
  createdAt: import_zod11.z.string().describe("Creation timestamp"),
  updatedAt: import_zod11.z.string().describe("Last update timestamp"),
  status: import_zod11.z.enum(["active", "inactive", "error"]).default("active"),
  config: import_zod11.z.union([MCPSingleAppServerSchema, MCPMultiAppServerSchema])
});
var MCPServerListResponseSchema = import_zod11.z.object({
  items: import_zod11.z.array(MCPServerSchema),
  total: import_zod11.z.number(),
  page: import_zod11.z.number(),
  pageSize: import_zod11.z.number()
});
var MCPServerUpdateParamsSchema = import_zod11.z.object({
  name: import_zod11.z.string().optional().describe("New name for the server"),
  toolkits: import_zod11.z.array(import_zod11.z.string()).optional().describe("Updated list of toolkits"),
  allowedTools: import_zod11.z.array(import_zod11.z.string()).optional().describe("Updated list of allowed tools")
});
...
var CustomCreateResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_zod11.z.string().nullish(),
  updatedAt: import_zod11.z.string().nullish(),
  status: import_zod11.z.string().nullish()
});
var ComposioCustomCreateResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  created_at: import_zod11.z.string().nullish(),
  updated_at: import_zod11.z.string().nullish(),
  status: import_zod11.z.string().nullish()
});
var McpListResponseSchema = import_zod11.z.object({
  items: import_zod11.z.array(
    import_zod11.z.object({
      id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
      name: import_zod11.z.string().min(1, "Server name cannot be empty"),
      createdAt: import_zod11.z.string().optional(),
      updatedAt: import_zod11.z.string().optional(),
      status: import_zod11.z.string().optional()
    })
  ).optional()
});
var ComposioMcpListResponseSchema = import_zod11.z.object({
  items: import_zod11.z.array(
    import_zod11.z.object({
      id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
      name: import_zod11.z.string().min(1, "Server name cannot be empty"),
      created_at: import_zod11.z.string().optional(),
      updated_at: import_zod11.z.string().optional(),
      status: import_zod11.z.string().optional()
    })
  ).optional()
});
var McpRetrieveResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_zod11.z.string().optional(),
  updatedAt: import_zod11.z.string().optional(),
  status: import_zod11.z.string().optional(),
  toolkits: import_zod11.z.array(import_zod11.z.string()).optional(),
  tools: import_zod11.z.array(import_zod11.z.string()).optional(),
  managedAuthViaComposio: import_zod11.z.boolean().optional(),
  authConfigIds: import_zod11.z.array(import_zod11.z.string()).optional(),
  mcpUrl: import_zod11.z.string(),
  commands: import_zod11.z.object({
    claude: import_zod11.z.string(),
    cursor: import_zod11.z.string(),
    windsurf: import_zod11.z.string()
  })
});
var ComposioMcpRetrieveResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  created_at: import_zod11.z.string().optional(),
  updated_at: import_zod11.z.string().optional(),
  ...
  toolkits: import_zod11.z.array(import_zod11.z.string()).optional(),
  tools: import_zod11.z.array(import_zod11.z.string()).optional(),
  managed_auth_via_composio: import_zod11.z.boolean().optional()
});
var McpDeleteResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  deleted: import_zod11.z.boolean().optional(),
  message: import_zod11.z.string().optional()
});
var ComposioMcpDeleteResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  deleted: import_zod11.z.boolean().optional(),
  message: import_zod11.z.string().optional()
});
var McpUpdateResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_zod11.z.string().optional(),
  updatedAt: import_zod11.z.string().optional(),
...
var ComposioMcpUpdateResponseSchema = import_zod11.z.object({
  id: import_zod11.z.string().min(1, "Server ID cannot be empty"),
  name: import_zod11.z.string().min(1, "Server name cannot be empty"),
  created_at: import_zod11.z.string().optional(),
  updated_at: import_zod11.z.string().optional(),
...
var ToolRouterToolkitConfigSchema = import_zod12.default.object({
  toolkit: import_zod12.default.string(),
  authConfigId: import_zod12.default.string().optional()
});
var ToolRouterConfigSchema = import_zod12.default.object({
  toolkits: import_zod12.default.array(import_zod12.default.union([import_zod12.default.string(), ToolRouterToolkitConfigSchema])).optional(),
  manuallyManageConnections: import_zod12.default.boolean().optional()
});
var ToolRouterSessionSchema = import_zod12.default.object({
  sessionId: import_zod12.default.string(),
