...
- **Optional Inputs**: description, private

### create_issue
- **Description**: Creates a GitHub issue
- **Required Inputs**: repo, title
- **Optional Inputs**: body

### create_pull_request
- **Description**: Creates a pull request
- **Required Inputs**: repo, title, base, head
- **Optional Inputs**: body
...
```javascript
const response = await fetch('http://localhost:3002/tool', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    unique_id: 'HEIR-2024-12-GITHUB-001',
...
```env
GITHUB_MCP_API_KEY=your_api_key_here
