...
- **Required Inputs**: diagram_id, updates
- **Optional Inputs**: None

### export_diagram
- **Description**: Exports a diagram
- **Required Inputs**: diagram_id, format
- **Optional Inputs**: None
...
```javascript
const response = await fetch('http://localhost:3008/tool', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    unique_id: 'HEIR-2024-12-WHIMSICAL-001',
...
```env
WHIMSICAL_MCP_API_KEY=your_api_key_here
