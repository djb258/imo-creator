...
| Doctrine Enforcement | `doctrine-enforcement.yml` | push to master/main/feature/fix + PR to master/main | Doctrine compliance CI gate + pressure test gate (mechanical, no override) |
