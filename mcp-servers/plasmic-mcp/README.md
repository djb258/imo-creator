...
- **Required Inputs**: project_id, version
...
```javascript
const response = await fetch('http://localhost:3005/tool', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    unique_id: 'HEIR-2024-12-PLASMIC-001',
...
```env
PLASMIC_MCP_API_KEY=your_api_key_here
