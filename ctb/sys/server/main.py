# # CTB Metadata
# # Generated: 2025-10-23T14:32:36.029347
# # CTB Version: 1.3.3
...
# Add tools directory to path for imports (CTB structure)
CTB_ROOT = Path(__file__).parent.parent.parent
sys.path.append(str(CTB_ROOT / "sys" / "tools"))
...
BASE_DIR = Path(__file__).parent.parent.parent  # CTB root
BLUEPRINTS_DIR = BASE_DIR / "docs" / "guides" / "blueprints"
