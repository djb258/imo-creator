...
## Tier 0 — Foundation (Governs All)

| Document | Location | Purpose |
|----------|----------|---------|
| Tier 0 Doctrine | law/doctrine/TIER0_DOCTRINE.md | The four irreducible elements, gate mechanism, altitude test. Governs all operations. |
