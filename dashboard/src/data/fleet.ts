...
export const fleet: FleetRepo[] = [
  ...
  },
  {
    ...
    path: '../Barton-Processes',
    purpose: 'Process engine — all executable code across the fleet',
    tier: 'Car',
    doctrineVersion: '3.5.0',
    syncStatus: 'SYNCED',
    status: 'ACTIVE',
    docs: [
      { file: 'CLAUDE.md', status: 'PRESENT' },
      { file: 'README.md', status: 'PRESENT' },
      { file: 'law/heir.yaml', status: 'PRESENT' },
      { file: 'law/orbt.yaml', status: 'PRESENT' },
      { file: 'law/process-registry.yaml', status: 'PRESENT' },
      { file: 'law/ingress-manifest.yaml', status: 'PRESENT' },
      { file: 'scripts/extraction-playbook.md', status: 'PRESENT' },
    ],
    workPackets: [
      {
        id: 'WP-BAR136',
        title: 'BAR-136: Build barton-processes repo',
        repo: 'barton-processes',
        status: 'IN_PROGRESS',
        agent: 'builder-1',
        currentPhase: 'Phase 1 — Repo Setup',
    ...
    todos: [
      { id: 'T-070', text: 'Extract CL processes (001-005)', priority: 'CRITICAL', done: false },
      { id: 'T-071', text: 'Extract outreach processes (006-011, 016)', priority: 'HIGH', done: false },
      { id: 'T-072', text: 'Extract field-monitor (012)', priority: 'NORMAL', done: false },
      { id: 'T-073', text: 'Extract client processes (013-014)', priority: 'NORMAL', done: false },
      { id: 'T-074', text: 'Extract sales processes (015)', priority: 'NORMAL', done: false },
    ],
  },
  {
    name: 'research',
